...
public class SkullBuilder_1_12_R1 implements SkullBuilder {
    private final ItemStack item = new ItemStack(Material.SKULL_ITEM, 1, (short) 3);
    private final SkullMeta meta = (SkullMeta) this.item.getItemMeta();

    @Override
    public SkullBuilder newInstance() {
        return new SkullBuilder_1_12_R1();
    }
