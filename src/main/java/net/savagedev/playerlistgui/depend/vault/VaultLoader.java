...
public class VaultLoader extends DependencyLoader implements VaultProvider {
    ...
    @Override
    protected void onDependencyFound() { // Woo! Vault was found on the server. We can start to gather all the services we need from Bukkit's ServicesManager.
        ...
        if (permissionRegistration != null) { // If one is available...
            this.permission = permissionRegistration.getProvider(); // Then we're good, get the provider.
